...
namespace MtSmart.WEB.ViewComponents
{
    public class CardAssessmentViewComponent : ViewComponent
    {
        ...
        public CardAssessmentViewComponent(IUnitOfWork unitOfWork)
        {
        ...
        private async Task<CardDetails> GetModelAsync(int cardId, int currentUserId)
        {
            ...
            var cardDetails = new CardDetails
            {
                ...
                assessmentQualityResults = assessmentQualityResults.ToList(),
                assessmentTermResults = assessmentTermResults.ToList(),
